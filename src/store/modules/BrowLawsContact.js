    ...
    state: {
        contact: {
            ...
            blockInfo: [
                ...
                {
                    title: "На метро:",
                    text: "Метро «Крылатское». Первый вагон из Центра, через турникеты налево, по лестнице направо, далее прямо по Осеннему бульвару (5-7 мин). С левой стороны трехэтажное здание Дома Бытовых услуг. Ориентиры: «Салон Красоты Brow&Laws». Салон красоты находится на 1 этаже.",
                },
            ],
            map: {
                nav: [
